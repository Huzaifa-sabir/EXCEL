...
<div><label>Subcategory</label><select id="subcategory">
<option>Work Visa</option>
<option>Job Seeker Visa</option>
<option>Medical Treatment Visa</option>
<option>Study Visa</option>
<option>Family Reunion Visa</option>
</select></div>
</div>
<div class="form-row">
...
<div class="form-row">
<div><label>Agent Name</label><input id="agentName"></div>
...
if(!f||!l){alert('Fill required fields: First Name and Last Name');return}
c.push({
firstName:f,
lastName:l,
