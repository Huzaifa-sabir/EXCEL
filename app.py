...
def generate():
    ...
    wb.defined_names.append(
        openpyxl.workbook.defined_name.DefinedName('City', attr_text="'Лист2'!$A$2")
    )
    wb.defined_names.append(
        openpyxl.workbook.defined_name.DefinedName('Category', attr_text="'Лист2'!$B$2:$B$3")
    )
    wb.defined_names.append(
        openpyxl.workbook.defined_name.DefinedName('National_Visa_Subcategory', attr_text="'Лист2'!$C$2:$C$6")
    )
    wb.defined_names.append(
        openpyxl.workbook.defined_name.DefinedName('Schengen_Visa_Subcategory', attr_text="'Лист2'!$D$2")
    )
    ...
    wb.defined_names.append(
        openpyxl.workbook.defined_name.DefinedName('Gender', attr_text="'Лист3'!$A$2:$A$3")
    )
    wb.defined_names.append(
        openpyxl.workbook.defined_name.DefinedName('Country', attr_text="'Лист3'!$B$2:$B$3")
    )
